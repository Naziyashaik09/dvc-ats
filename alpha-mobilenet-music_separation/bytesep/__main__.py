...
def download_checkpoints(args) -> NoReturn:
    ...
    checkpoint_names = [
        ...
        "resunet143_subbtandtime_accompaniment_1nt.4dB_500k_steps_v2.pth?download=1",
    ]
    ...
    if model_type == "MobileNet_Subbandtime":
        ...
        if source_type == "vocals":
            ...
            config_yaml = os.path.join(
                ...
                "vocals-accompaniment,mobilenet_subbandtime.yaml",
            )
            ...
            config_yaml = os.path.join(
                local_checkpoints_dir,
                "accompaniment-vocals,mobilenet_subbandtime.yaml",
            )
        ...
        if source_type == "vocals":
            ...
            config_yaml = os.path.join(
                local_checkpoints_dir,
                "vocals-accompaniment,resunet_subbandtime.yaml",
            )
            ...
            config_yaml = os.path.join(
                local_checkpoints_dir,
                "accompaniment-vocals,resunet_subbandtime.yaml",
            )
